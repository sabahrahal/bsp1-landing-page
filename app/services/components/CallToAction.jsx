...
export const CallToAction = () => {
  return (
    <section className="my-[100px] md:my-[150px]">
        <div className="flex flex-col-reverse gap-y-2 lg:gap-y-0 lg:flex-row items-center bg-gray-100 rounded p-4">
            <div className="lg:w-2/5">
                <h3 className="text-4xl font-bold mb-2 text-main text-center lg:text-left">You Have Questions, We Have Answers.</h3>
                <p className="text-md lg:text-xl font-bold max-w-xl text-justify">Contact Blessed Solutions today for professional plumbing services tailored to your needs. 
                Our team of experts is ready to provide efficient and reliable solutions for all your plumbing requirements.</p>
