...
export const WhyChoose = () => {
  return (
    <section>
        <p className="text-center text-4xl font-bold">Why choose Blessed Solutions?</p>
        ...
        <div className="flex bg-gray-100 rounded flex-col lg:flex-row mt-10 drop-shadow-lg">
            ...
            <div className="lg:w-2/5 p-4">
                ...
                <div className="text-md lg:text-xl mt-6 lg:mt-10 md:max-w-2xl lg:hyphens-auto flex flex-col" lang="en">
                    ...
                    <div>
                        <Link href={"/about-us"} className="lg:w-40 py-4 px-2 bg-main text-white font-bold rounded flex text-lg items-center justify-center uppercase mt-6 hover:bg-secondary duration-300">
